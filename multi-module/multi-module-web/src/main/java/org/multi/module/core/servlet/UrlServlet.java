package org.multi.module.core.servlet;
...
//        SessionInfo obj = (SessionInfo)session.getAttribute(ConfigUtil.getSessionInfoName());
        String page = request.getParameter("page");
//        if (obj != null)
//        {                   
//            boolean result = AuthManager.getInstance().checkAuthForUrlOfJsp(obj.getUserId(), page);
//            if(result==false)
//            {
//                page = null;
//            }
